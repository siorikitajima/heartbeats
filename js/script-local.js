var anim, animalData;
const animalJsonUrl = 'js/animal_data.json';
...
// Open/Close Analytics panels

  var mobileNav = document.getElementById("mobileNav");
  var analyticsPanel = document.getElementById("analytics");
  var analyticsIsOpen = false;

  function handleAnalytics() {
    var positionTop = mobileNav.style.top;
    if(positionTop == "0px") {
        positionTop = "-150px"
    }
    if(analyticsIsOpen) {
        analyticsPanel.style.top = '-100vh';
    } else {
        analyticsPanel.style.top = 0;
    }
...
//         }    
//       }, 200);
//   var arrowsAlreadyShown = $('#rightArrowAnalytics').hasClass('displayNone');
//   var arrowsAlreadyShownMobile = $('#rightArrowMobile').hasClass('displayNone');
// });
